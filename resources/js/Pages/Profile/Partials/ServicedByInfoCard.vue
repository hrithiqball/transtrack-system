...
<template>
  <div
    class="flex flex-col items-center space-y-4 rounded-lg bg-slate-200 p-4 dark:bg-slate-700"
  >
    <span class="text-lg font-semibold">Serviced By</span>
    <div
      class="flex size-6 items-center justify-center rounded-full bg-slate-300 dark:bg-slate-800"
    >
