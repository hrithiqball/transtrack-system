    ...
    <div class="flex flex-1 flex-col items-center justify-center space-y-4">
      <div>
        ...
        >
          ...
          <div
            class="my-4 flex size-24 flex-col items-center justify-center rounded-full bg-gray-100 p-6 dark:bg-gray-700"
          >
          ...
          <div
            class="my-4 flex w-full flex-col rounded-lg bg-gray-100 p-4 dark:bg-gray-900"
          >
